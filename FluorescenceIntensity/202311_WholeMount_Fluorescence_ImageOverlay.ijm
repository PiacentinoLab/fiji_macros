...
first_channel_name = "SOX10"
second_channel_number = 3
second_channel_name = "PAX7"
...
//Measure areas
selectWindow("C"+toString(first_channel_number)+"-A");
rename(first_channel_name);
roiManager("Show All");
roiManager("Select", 0);
run("Measure");
roiManager("Select", 1);
...
selectWindow("C"+toString(second_channel_number)+"-A");
rename(second_channel_name);
roiManager("Show All");
roiManager("Select", 0);
run("Measure");
roiManager("Select", 1);
